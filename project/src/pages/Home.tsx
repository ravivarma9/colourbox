...
import BlueArtCafeSection from '../components/BlueArtCafeSection';
import ActivitiesSection from '../components/ActivitiesSection';
import PhotosVideosSection from '../components/PhotosVideosSection';
import LocationAttractionSection from '../components/LocationAttractionSection';
import GuestExperiencesSection from '../components/GuestExperiencesSection';
import NewsletterSection from '../components/NewsletterSection';
import deluxeRoom1 from "/assets/Deluxe_room_with_kitchen/Common_9.jpg";
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20 bg-white">
        ...
        <img
          src={deluxeRoom1}
          alt="ColourBox Exterior or Interior"
